...
#define IRQ_PORT			RK30_PIN1_PB7
#define WAKE_PORT			RK30_PIN0_PB6
#define I2C_SCL				300*1000
...
static u32 gsl_read_interface(struct i2c_client *client, u8 reg, u8 *buf, u32 num)
{
	...
	xfer_msg[0].buf = &reg;
	xfer_msg[0].scl_rate = I2C_SCL; //RK3066 RK2926 I2C报错时打开这个

	xfer_msg[1].addr = client->addr;
	xfer_msg[1].len = num;
	xfer_msg[1].flags |= I2C_M_RD;
	xfer_msg[1].buf = buf;
	xfer_msg[1].scl_rate = I2C_SCL; //RK3066 RK2926 I2C报错时打开这个
